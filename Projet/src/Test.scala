...
object Test extends App {
  ...
  val ptCardTondeuse1 = lines(1).split(" ")(2).charAt(0)

  val série1 = lines(2).toString

  var Tondeuse1= new Tondeuse("Tondeuse 1", xLim, yLim, ptCardTondeuse1, xTondeuse1, yTondeuse1)
  ...
  val ptCardTondeuse2 = lines(3).split(" ")(2).charAt(0)

  val série2 = lines(4).toString

  var Tondeuse2 = new Tondeuse("Tondeuse 2", xLim, yLim, ptCardTondeuse2, xTondeuse2, yTondeuse2)
